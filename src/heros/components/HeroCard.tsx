...
export const HeroCard=({hero}:any)=>{
  ...
  return (
      <div onClick={onGoToHero(hero.id)} data-testid="hero_card" className="m-8 w-56 pb-5 cursor-pointer max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
